/* -------------------------------------------------
 ...
 <Desc> Indexadores </Desc>
  
 public typeX this[typeY var]
        {
            get { }
            set { }
        }
...
namespace Revisoes
{
    ...
    class Pessoas
    {
        ...
        /// <summary>
        /// Indexador pelo nome da pessoa
        /// </summary>
        /// <param name="nome"></param>
        /// <returns></returns>
        public Pessoa this[string nome]
        {
            get { return WhereIs(nome); }       //Validações
            //set { //i=ProcuraPosicao(nome); //InserePessoa(value,i); numPess++; }
        }
