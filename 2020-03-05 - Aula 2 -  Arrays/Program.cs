...
namespace MyArrays
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                if (melhorNota < turma[i].notaLP2) //Trocar
                {
                    melhorNota = turma[i].notaLP2;
                    nomeMelhorNota = turma[i].nome;
                    posMelhorNota = i;
                }
                i++;
            }
            ...
            while (i < turma.Length)
            {
                if (melhorNota ==turma[i].notaLP2) //Trocar
                {
                    Console.WriteLine("Nome: {0} \t Número: {1} \t Nota LP2: {2}", turma[i].nome, turma[i].numero, turma[i].notaLP2.ToString());
                }
                i++;
            }
